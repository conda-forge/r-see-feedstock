...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-see-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11645&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-see-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-see` can be installed with:

```
conda install r-see
```

It is possible to list all of the versions of `r-see` available on your platform with:
